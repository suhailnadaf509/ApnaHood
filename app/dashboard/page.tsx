...
import { Bell, Heart, MapPin, MessageCircle, PawPrintIcon as Paw, Search, Shield, Users } from "lucide-react"
...
const openEventPopup = (event: { title: string; date: string; description: string }) => {
        ...
        <div className="mb-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className="transition-transform hover:scale-105">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Find Lost Pets</CardTitle>
          ...
          <Card className="transition-transform hover:scale-105">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Food banks, shelters & more</p>
            </CardContent>
          </Card>
          <Card className="transition-transform hover:scale-105">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <div className="grid gap-6 md:grid-cols-7">
          ...
          <Card className="col-span-4">
            <CardHeader>
              ...
              <CardDescription>Recent updates from your neighborhood</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <Card className="border-red-200 bg-red-50 dark:bg-red-900/10">
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm font-medium text-red-600">Emergency Alert</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm">Flash flood warning in effect for downtown area. Seek higher ground.</p>
                      <p className="mt-1 text-xs text-red-600">Posted 5 minutes ago</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-sm font-medium">Sarah M.</CardTitle>
                      </div>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm">
                        Lost golden retriever near Central Park. Responds to &quot;Max&quot;. Please call if spotted!
                      </p>
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-sm font-medium">Food Bank</CardTitle>
                      </div>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm">
                        Extra supplies available today. Open until 7 PM. No registration required.
                      </p>
                      <div className="mt-2">
                        <Button variant="ghost" size="sm" className="h-8">
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-sm font-medium">Pet Care Clinic</CardTitle>
                      </div>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm">Free vaccination drive this Saturday. First come, first served basis.</p>
                      <div className="mt-2">
                        <Button variant="ghost" size="sm" className="h-8">
          ...
          <div className="col-span-3 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Find resources or report sightings</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div
                    ...
                    onClick={() =>
                      openEventPopup({
                        ...
                        date: "Tomorrow, 9 PM",
                        description:
                          "Join us for a night of music and dance celebrating our community's diverse cultural heritage.",
                      })
                    }
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Tomorrow, 9 PM</p>
                    </div>
                  </div>
                  <div
                    className="flex items-center gap-4 cursor-pointer hover:bg-gray-100 p-2 rounded-lg transition-colors"
                    onClick={() =>
                      openEventPopup({
                        ...
                        date: "This Weekend",
                        description:
                          "Experience nature up close with our family-friendly camping trip in the nearby national park.",
                      })
                    }
                  >
                    ...
                    <div>
                      <p className="text-sm font-medium">Jungle Camp</p>
            ...
            <Card className="border-orange-200 bg-orange-50 dark:bg-orange-900/10">
              ...
              <CardContent>
                <p className="text-sm text-orange-600">Heavy rain expected this evening. Keep pets indoors.</p>
              </CardContent>
            </Card>
          </div>
        </div>
