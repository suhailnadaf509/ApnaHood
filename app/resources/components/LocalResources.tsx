...
import { categories as initialCategories, type Category, type Resource } from "../data/localResources"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/add-resource" className="bg-[#5a5a5a] text-white px-4 py-2 rounded hover:bg-[#6a6a6a]">
          Add Resource
        </Link>
      </div>
